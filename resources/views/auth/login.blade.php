...
<head>
    <!-- Title -->
    <title>Connexion - iBudgetApp</title>
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <h4 class="text-center mb-4">Se connecter à votre compte</h4>
                                    <form action="{{ route('auth.handleLogin') }}" method="POST">
                                      @csrf
                                        ...
                                        <div class="mb-4 position-relative">
                                            ...
                                            <input type="password" id="dz-password" class="form-control" name="password" placeholder="******">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-primary light btn-block">Se connecter</button>
                                        </div>
                                    </form>
