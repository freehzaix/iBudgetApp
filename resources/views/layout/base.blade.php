...
<head>
    <!-- Title -->
    <title>@yield('titlePage') - iBudgetApp</title>
    ...
    <meta name="keywords" content="iBudgetApp">
    <meta name="description" content="iBudgetApp">

    <meta property="og:title" content="iBudgetApp">
    <meta property="og:description" content="iBudgetAp">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/dashboard" class="brand-logo" aria-label="iBudgetApp">
                <img class="logo-abbr" src="./images/logo.png" alt="">
                <h2 class="mt-2">&nbsp; iBudgetApp</h2>
            </a>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button"
                                    ...
                                    <div class="header-info">
                                        <span class="text-black"><strong>{{ Auth::user()->prenom }}
                                                {{ Auth::user()->nom }}</strong></span>
